...
export const agentRegistry: Record<string, AgentMission> = {
  ceo: {
    ...
    toolsAllowed: ["agent_registry", "workflow_router"],
  ...
  product_owner: {
    ...
    toolsAllowed: ["intent_parser", "brief_generator"],
    mustProduce: ["brief"],
  ...
  logo_designer: {
    ...
    toolsAllowed: ["svg_draft_renderer"],
  ...
  creative_director: {
    ...
    toolsAllowed: ["quality_gates", "design_rubric"],
  ...
  ux_designer: {
    ...
    toolsAllowed: ["wireframe_generator"],
  ...
  web_designer: {
    ...
    toolsAllowed: ["svg_preview_renderer"],
  ...
  frontend_builder: {
    ...
    toolsAllowed: ["svg", "react_component"],
  ...
  research_agent: {
    ...
    toolsAllowed: ["local_context", "web_if_enabled"],
    mustProduce: ["context"],
  ...
  browser_agent: {
    ...
    skills: ["parse_user_request"],
    toolsAllowed: ["browser_if_enabled"],
  ...
  artifact_manager: {
    ...
    toolsAllowed: ["artifact_manifest"],
